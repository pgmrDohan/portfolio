...
정적 웹 사이트 + 깃허브 기반의 CMS

- 배포 @Github Pages
- 다국어 지원 @Cloudflare Worker
- 정적 데이터 업데이트 @Github Actions
...
├── languages.js
├── posts
│   ├── en-x86-64-registers.md
│   ├── index.html
│   └── ko-x86-64-registers.md
├── posts.json
├── projects
│   ├── index.html
│   └── ko-portfolio.md
